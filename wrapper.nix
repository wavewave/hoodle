...
in stdenv.mkDerivation {
     ...
     buildCommand = ''
       ...
       makeWrapper ${hoodleEnv}/bin/hoodle $out/bin/hoodle \
        ...
        --set XDG_DATA_DIRS "${gtk3}/share/gsettings-schemas/${gtk3.name}:${gnome3.gsettings_desktop_schemas}/share/gsettings-schemas/${gnome3.gsettings_desktop_schemas.name}:${gnome3.defaultIconTheme}/share"
     '';
   }
