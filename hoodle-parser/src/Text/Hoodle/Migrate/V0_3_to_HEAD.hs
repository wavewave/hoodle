...
-----------------------------------------------------------------------------
-- |
-- Module      : Text.Hoodle.Migrate.V0_3_to_HEAD
...
link2Link OH.LinkDocID {..} = NH.LinkDocID { NH.link_id = link_id 
                                           ...
                                           , NH.link_pos = link_pos
                                           , NH.link_dim = dim2Dim link_dim }
link2Link OH.LinkAnchor {..} = NH.LinkAnchor { NH.link_id = link_id
                                             , NH.link_linkeddocid = link_linkeddocid
                                             , NH.link_location = link_location
...
anchor2Anchor OH.Anchor {..} = NH.Anchor { NH.anchor_id = anchor_id
...
hoodle2Hoodle oh = do
    ...
    set NH.title ttl . set NH.pages pgs <$> NH.emptyHoodle 
