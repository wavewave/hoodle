...
-- | isDoorOpen lens
objDoor :: Simple Lens (WorldActor m) (ServerObj SubOp (StateT (WorldAttrib m) m) ())
objDoor = lens _objDoor (\a b -> a { _objDoor = b })


-- | messageBoard lens
objMessageBoard :: Simple Lens (WorldActor m) (ServerObj SubOp (StateT (WorldAttrib m) m) ()) 
objMessageBoard = lens _objMessageBoard (\a b -> a { _objMessageBoard = b })

-- | air lens 
objAir :: Simple Lens (WorldActor m) (ServerObj SubOp (StateT (WorldAttrib m) m) ())
